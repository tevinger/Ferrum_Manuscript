...
```{r}
Seep_ficklin_plot <- 
  ggplot(All_Seep_Data, aes(x = pH, y = Ficklin_sum_of_metals_ug_L, fill = Watershed)) +
  ...
  scale_fill_manual(values = boxplot_colors) +
  geom_point(size = 4, shape = 21, color = "black", stroke = 1.5) +           # scatter points
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Seeps Ficklin Diagram_log scale_V2_no labels.png", Seep_ficklin_plot, width = 4, height = 4, dpi = 300, bg = "transparent")
