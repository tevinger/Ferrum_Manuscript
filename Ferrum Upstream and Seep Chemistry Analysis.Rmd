...
Ca_Mg_ratio <- working_Ferrum_data_molar %>%
  ...
  geom_rect(aes(xmin = -Inf, xmax = Inf, ymin = 0, ymax = 1),
            fill = "grey95", color = NA, alpha = 1/2, inherit.aes = FALSE) +
  geom_rect(aes(xmin = -Inf, xmax = Inf, ymin = 1, ymax = 2),
            fill = "white", color = NA, alpha = 1/2, inherit.aes = FALSE) +
  geom_rect(aes(xmin = -Inf, xmax = Inf, ymin = 2, ymax = 5),
            fill = "grey85", color = NA, alpha = 1/3, inherit.aes = FALSE) +
