...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Ficklin Diagram metal composition no labels wide.png", stacked_pct_plot, width = 4, height = 4, dpi = 300)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Metal Phase/Seep_2.png", f_vs_p_by_metal_bp_seep, width = 8, height = 5, dpi = 300)
```
...
f_and_p_summary_stats_metal_specific <- f_and_p_summary_stats_metal_specific %>%
  mutate(
    x_group = factor(
      ...
      levels = c("Unimpaired Tributary_Filtered", "Unimpaired Tributary_Particulate", "Upstream_Filtered", "Upstream_Particulate", "Seep_Filtered", "Seep_Particulate", "Impaired Tributary_Filtered", "Impaired_Particulate", "Downstream MS_Filtered", "Downstream MS_Particulate")
    )
  )
...
```{r}
metal_fraction_bp <- ggplot(
  f_and_p_summary_stats_metal_specific,
  aes(
    x = x_group,
    y = mean,
    fill = New_Grouping,          # color by grouping
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Metal Phase/Site classification group_means.png", metal_fraction_bp, width = 6.5, height = 6, dpi = 300)
```
