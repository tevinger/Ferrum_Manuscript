...
piper.diagram(
  ...
  sample_id = "sample_id",
  title     = "Piper Diagram (hydrogeo)",
  cex       = 1.2,                 # point size
  pch       = 21,                  # filled circles
  col       = "black",
  bg        = c("#1f77b4", "#2ca02c", "#d62728")  # fill per sample
)
```


```{r}
# --- Classic Piper diagram (center diamond included) ---
png("piper_hydrogeo.png", width = 1100, height = 800, res = 120)
piper.diagram(
  x         = ex_meq,
  cations   = c("Ca", "Mg", "Na", "K"),
  anions    = c("Cl", "SO4", "HCO3"),
  ...
  col       = "black",
  bg        = c("#1f77b4", "#2ca02c", "#d62728")  # fill by sample (3 colors)
)
dev.off()
cat("Saved: piper_hydrogeo.png\n")
```
