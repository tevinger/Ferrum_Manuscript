...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Metal Phase/Seep.png", f_vs_p_by_metal_bp_seep, width = 12.5, height = 6, dpi = 300)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Metal Phase/Impaired Trib.png", f_vs_p_by_metal_bp_impaired_trib, width = 12.5, height = 6, dpi = 300)
```
