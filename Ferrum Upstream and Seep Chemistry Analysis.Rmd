...
Seep_ficklin_plot <- 
  ...
  # Data points
    ...
    geom_point(data = G_and_K_2009_Ficklin, # impaired data
             aes(x = pH, y = Ficklin_metals, color = Watershed),
             size = 3, shape = 17, alpha = .5) +
...
#ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Ficklin Diagram/Seeps Ficklin Diagram_v2_with lit values.png", Seep_ficklin_plot, width = 5, height = 5, dpi = 300, bg = "transparent")
