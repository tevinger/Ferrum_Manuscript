...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/02_Global Analysis/SpC_no labels.png", SpC_plot, width = 1.5, height = 3.5, dpi = 300)
```

## DO
```{r}
# Select DOC data
DO_df <- Alaska_DataRelease_2022_2023_Ferrum_V9 %>%
...
# ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/02_Global Analysis/DIC_V2 labels.png", DIC_plot, width = 1.5, height = 3.5, dpi = 300)
```
...
```{r}
# Select DOC data
DIC_df <- Alaska_DataRelease_2022_2023_Ferrum_V9 %>%
