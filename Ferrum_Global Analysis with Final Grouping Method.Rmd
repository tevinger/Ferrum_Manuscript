...
```{r}
# Select Al data
Al_df <- Alaska_DataRelease_2022_2023_Ferrum_V8 %>%
...
scale_y_log10(
    limits = c(0.0001, 10000000),
    labels = scales::comma,
    breaks = c(0.0001, 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000),
    minor_breaks = NULL
  ) +
  annotation_logticks(sides = "l") +
  labs(
...
```{r}
# Select Cu data
Cu_df <- Alaska_DataRelease_2022_2023_Ferrum_V8 %>%
  dplyr::select(SamplingEventID, Watershed, New_Groups, New_Grouping, 
...
Cu_plot <- ggplot(Cu_long, aes(x = x_group, y = Metal_conc_plot)) +
  ...
  scale_y_log10(
    ...
    labels = scales::comma,
    breaks = c(0.0001, 0.1, 1, 10, 100, 1000, 10000),
    minor_breaks = NULL
  ) +
  annotation_logticks(sides = "l") +
  labs(
...
```{r}
# Select Zn data
Zn_df <- Alaska_DataRelease_2022_2023_Ferrum_V8 %>%
  dplyr::select(SamplingEventID, Watershed, New_Groups, New_Grouping, 
...
Zn_plot <- ggplot(Zn_long, aes(x = x_group, y = Metal_conc_plot)) +
  ...
  scale_y_log10(
    ...
    labels = scales::comma,
    breaks = c(0.0001, 0.1, 1, 10, 100, 1000, 10000, 100000, 1000000),
    minor_breaks = NULL
  ) +
  annotation_logticks(sides = "l") +
  labs(
