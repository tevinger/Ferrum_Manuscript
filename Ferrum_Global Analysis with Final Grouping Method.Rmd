...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/02_Global Analysis/pH_with labels.png", pH_plot_no_jitter, width = 1.5, height = 3.5, dpi = 300)
```
