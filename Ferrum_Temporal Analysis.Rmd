...
ggsave("C:/Users/tevinger/Downloads/Total Discharge draft.png", q.p_2, width = 11, height = 7)
...
discharge_bps <- ggplot(yearly_discharge, 
                aes(x = Onset_timing, y = average_discharge_cfs, fill = station_nm)) +
  geom_boxplot() +
...
ggsave("C:/Users/tevinger/Downloads/Onset timing Discharge V2.png", discharge_bps, width = 10, height = 5)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Red Dog Temporal/SO4_2015 to 2024.png", RD_Sulfate_temporal_bp, width = 3.5, height = 4.25, dpi = 300, bg = "transparent")
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/04_Agashashok Temporal Analysis/SO4 seasonal temporal bp_V3_smaller.png", Sulfate_temporal_bp, width = 3.5, height = 4.25, dpi = 300, bg = "transparent")
```
