...
Sulfate_temporal_bp <- temporal_filled %>%
  ...
  geom_boxplot() +
  scale_y_continuous(breaks = c(0,25,50,75,100,125,150,175,200,225), labels = c(0, "", 50, "", 100, "", 150, "", 200, "")) +
  ...
  # Add counts as text
  geom_vline(xintercept = 4.5, linetype = "dashed", color = "black", size = 1, alpha = 0.6) +
  labs(
    title = NULL, 
