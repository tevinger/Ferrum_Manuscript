...
RD_SO4_Cl_temporal_bp <- RD_SO4_Cl_clean_ALL %>%
  ...
  geom_boxplot(position = position_dodge(width = 0.75), width = 0.55) +
  scale_y_continuous(breaks = c(0,200,400,600,800,1000,1200,1400,1600), labels = c(0, "", 400, "", 800, "", 1200, "", 1600)) +
  #scale_x_continuous(expand = expansion(mult = c(0.035, 0.025))) +
  #scale_y_log10() +
  scale_fill_manual(
    values = c("early" = "#e6bed6", "late" = "#bc5090")
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/Red Dog Temporal/SO4_1998 to 2025.png", RD_SO4_Cl_temporal_bp, width = 6.5, height = 5, dpi = 300, bg = "transparent")
```
...
RD_data_2018_2019 <- RD_temporal_stats %>%
  filter(sample_collection_year %in% c("2018", "2019", "2020")) %>%
...
write_xlsx(RD_temporal_stats_summary, "C:/Users/tevinger/Downloads/Red Dog Station 9 summary stats with season_corrected for metals.xlsx")
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/04_Agashashok Temporal Analysis/SI/Aggie SO4 to Cl.png", Aggie_SO4_Cl_temporal_bp, width = 3.5, height = 5, dpi = 300, bg = "transparent")
```
