...
can you rewrite this code multiple times so that where it says "Fe" it says "As", "Ba", "La", "Co", "Cr", "La", "Mn", "Ni", "Pb", "Se", "U", "Pb" and where it says "Fe_mcg_per_l" it says "Co_mcg_per_l", "Mn_mcg_per_l", "Zn_mcg_per_l", "Ni_mcg_per_l", "Cr_mcg_per_l", "Se_mcg_per_l", "As_mcg_per_l", "Ba_mcg_per_l", "La_mcg_per_l", "U_mcg_per_l", "Pb_mcg_per_l"
...
```{r}
# filter out samples without a Site_Group
stats_working_Ferrum_data <- working_Ferrum_data %>%
  dplyr::select(-contains("QA_flag")) %>%
  dplyr::select(-contains("tot_")) %>%
  filter(Site_Group != "NA") 
...
column_order <- c(
  ...
  "f_Pb_Sum_Mean", "f_Pb_Sum_SD", "f_Pb_Sum_Count",
  "p_Pb_Sum_Mean", "p_Pb_Sum_SD", "p_Pb_Sum_Count",
...
elements <- c(
  ...
  "f_206Pb", "f_207Pb", "f_208Pb", "f_Pb_Sum", "p_Pb_Sum", "f_Ag", "f_Al", 
  "p_Al", "f_As", "p_As", "f_Ba", "f_Be", "f_Br", "f_Cd", "p_Cd", "f_Ce", 
  "p_Ce", "f_Co", "p_Co", "f_Cr", "p_Cr", "f_Cu", "p_Cu", "f_Dy", "p_Dy", 
  "f_Fe", "p_Fe", "f_La", "p_La", "f_Mn", "p_Mn", "f_Nd", "p_Nd", "f_Ni", 
  "p_Ni", "f_Pr", "p_Pr", "f_Se", "p_Se", "f_Th", "f_Tl", "f_U", "f_V", "f_Y", 
  "p_Y", "f_Zn", "p_Zn", "f_sum_REE", "p_sum_REE"
)

columns <- c(
  "pH", "Temp_deg_celsius", "Diss_oxy_mg_per_l", "Diss_oxy_percent_sat", "Spec_Cond_microS_per_cm", 
  "DIC_mgC_per_l", "Alk_mgCaCO3_per_l", "DOC_mgC_per_l", "f_Cl_mg_per_l", "f_NO3_mg_per_l", 
  "f_SO4_mg_per_l", "f_Ca_mg_l", "f_Mg_mg_l", "f_Na_mg_l", "f_K_mg_l", "f_206Pb_mcg_per_l", 
  "f_207Pb_mcg_per_l", "f_208Pb_mcg_per_l", "f_Pb Sum_mcg_per_l", "p_Pb Sum_mcg_per_l", 
  "f_Ag_mcg_per_l", "f_Al_mcg_per_l", "p_Al_mcg_per_l", "f_As_mcg_per_l", "p_As_mcg_per_l", 
  "f_Ba_mcg_per_l", "f_Be_mcg_per_l", "f_Br_mcg_per_l", "f_Cd_mcg_per_l", "p_Cd_mcg_per_l", 
  "f_Ce_mcg_per_l", "p_Ce_mcg_per_l", "f_Co_mcg_per_l", "p_Co_mcg_per_l", "f_Cr_mcg_per_l", 
  "p_Cr_mcg_per_l", "f_Cu_mcg_per_l", "p_Cu_mcg_per_l", "f_Dy_mcg_per_l", "p_Dy_mcg_per_l", 
  "f_Fe_mcg_per_l", "p_Fe_mcg_per_l", "f_La_mcg_per_l", "p_La_mcg_per_l", "f_Mn_mcg_per_l", 
  "p_Mn_mcg_per_l", "f_Nd_mcg_per_l", "p_Nd_mcg_per_l", "f_Ni_mcg_per_l", "p_Ni_mcg_per_l", 
  "f_Pr_mcg_per_l", "p_Pr_mcg_per_l", "f_Se_mcg_per_l", "p_Se_mcg_per_l", "f_Th_mcg_per_l", 
  "f_Tl_mcg_per_l", "f_U_mcg_per_l", "f_V_mcg_per_l", "f_Y_mcg_per_l", "p_Y_mcg_per_l", 
  "f_Zn_mcg_per_l", "p_Zn_mcg_per_l", "f_sum_REE_mcg_per_l", "p_sum_REE_mcg_per_l"
)
...
for (i in seq_along(elements)) {
  ...
  summary_stats <- stats_working_Ferrum_data %>%
    ...
    group_by(Site_Group) %>% #This is where you can change what variable you want to group the data by
    summarise(
      Variable = element,
      Mean = round(mean(.data[[column]], na.rm = TRUE), 2),  
      SD = round(sd(.data[[column]], na.rm = TRUE), 2),     
...
write_xlsx(summary_stats_wide, "C:/Users/tayta/Downloads/Proximity Group Summary Stats.xlsx")
...
for (i in seq_along(elements)) {
  ...
  test_result <- tryCatch(
    shapiro.test(stats_working_Ferrum_data[[column]]),
...
kruskal_results <- data.frame(Element = character(), Kruskal_P_Value = numeric(), stringsAsFactors = FALSE)
...
for (i in seq_along(elements)) {
  ...
  # Perform Kruskal-Wallis test
  kruskal_test_result <- kruskal.test(as.formula(paste(column, "~ Site_Group")), data = stats_working_Ferrum_data)
  
  # Store the result in a dataframe
  kruskal_results <- rbind(kruskal_results, data.frame(Variable = element, Kruskal_P_Value = kruskal_test_result$p.value))
}
...
write_xlsx(shapiro_results, "C:/Users/tayta/Downloads/Shapiro and Kruskal proximity results.xlsx")
...
for (i in seq_along(elements)) {
  ...
  if (kruskal_test_result$p.value < 0.05) {
    # Perform Dunn's post-hoc test with Bonferroni adjustment
    dunn_result <- dunn.test(stats_working_Ferrum_data[[column]], stats_working_Ferrum_data$Site_Group, 
                             method = "bonferroni")
    
    # Extract unique group levels
    groups <- unique(stats_working_Ferrum_data$Site_Group)
    ...
    comparison_df <- merge(comparison_df, letters_df, by.x = "Group1", by.y = "Site_Group", all.x = TRUE)
    comparison_df <- merge(comparison_df, letters_df, by.x = "Group2", by.y = "Site_Group", all.x = TRUE, suffixes = c("_Group1", "_Group2"))
