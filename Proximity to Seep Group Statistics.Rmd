...
for (i in seq_along(elements)) {
  ...
  test_result <- tryCatch(
    shapiro.test(Grouped_Ferrum_2022_2023_data[[column]]),
...
for (i in seq_along(elements)) {
  ...
  # Perform Kruskal-Wallis test
  kruskal_test_result <- kruskal.test(as.formula(paste(column, "~ Site_Group")), data = Grouped_Ferrum_2022_2023_data)
