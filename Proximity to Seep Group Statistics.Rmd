...
for (i in seq_along(elements)) {
  ...
  summary_stats <- 
    ...
    dplyr::select(2,4,19:83) %>% # New Grouping
...
elements <- c("sum of filtered metals", "sum of particulate metals")
columns <- c("f_sum_all_metals", "p_sum_all_metals")
...
quartiles_df <- quartiles_df %>%
  ...
  mutate(joining = paste(Watershed, New_Grouping, Variable, sep = "_"))
...
write_xlsx(summary_combined, "C:/Users/tevinger/Downloads/Group and Watershed summary stats_rstatix.xlsx")
```
