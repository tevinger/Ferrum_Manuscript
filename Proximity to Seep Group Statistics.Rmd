...
for (i in seq_along(elements)) {
  ...
  summary_stats <- stats_working_Ferrum_data %>%
    ...
    #group_by(New_Groups) %>% #This is where you can change what variable you want to group the data by
    summarise(
    Variable = element,
    Mean = round(mean(.data[[column]], na.rm = TRUE), 2),
    SD = round(sd(.data[[column]], na.rm = TRUE), 2),
...
write_xlsx(summary_stats_wide, "C:/Users/tevinger/OneDrive - University of California, Davis/Lab/Alaska Projects/uncorrected DL summary stats.xlsx")
