...
# Save
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SalmonR Ni_with DL box.png", SalmonR_Ni_combo, width = 4.95, height = 2.5, dpi = 300)
```
...
SalmonR_REE_bottom <- ggplot() +
  ...
  coord_cartesian(x = c(0, 22), y = c(0.005, 250)) +
  scale_x_continuous(breaks = DA_breaks, labels = DA_labels) +
  scale_y_log10(breaks = c(0.001,0.01,0.1, 1, 10, 100), labels = scales::comma) +
  annotation_logticks(sides = "l") +
  labs(x = "Distance Downstream (km)", y = NULL, color = "Legend") +
  theme_minimal() +
  DA_theme +
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SalmonR REE_with DL box.png", SalmonR_REE_combo, width = 5.1, height = 2.5, dpi = 300)
```
