...
SalmonR_filtered_MS <- SalmonR_2023_river_data %>%
  ...
  mutate(Hyd_Classification = ifelse(is.na(Hyd_Classification), "normal", Hyd_Classification))

SalmonR_filtered_Trib <- SalmonR_2023_river_data %>%
  filter(Hyd_Classification == "Tributary") %>%
  mutate(Hyd_Classification = ifelse(Hyd_Classification == "Downstream MS", "trib", Hyd_Classification))
