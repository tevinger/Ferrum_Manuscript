...
SalmonR_Fe_area <- ggplot() +
  ...
  scale_x_continuous(breaks = DA_x_breaks, labels = DA_x_labels, expand = expansion(mult = c(0.02, 0.02))) +
...
### Trib heat plot
```{r}
f_Fe_heat <- ggplot(trib_f_Fe_area, aes(x = Rel_Water_Area_plotting, y = 1000, fill = Metal_conc)) +
