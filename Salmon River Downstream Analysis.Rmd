...
SalmonR_Fe_top <- ggplot() +
  # Line plot for SalmonR_filtered_MS
  geom_line(data = SalmonR_filtered_MS, aes(x = Rel_Water_Area_plotting, y = f_Fe_mcg_per_l), color = "black", size = 1) +
geom_point(data = SalmonR_filtered_MS, aes(x = Rel_Water_Area_plotting, y = f_Fe_mcg_per_l), pch = 21, color = "black", 
           #fill = "#2DAA9E",
           fill = "#28968b",
           size = 4, stroke = 1.3) +
  # Points for SalmonR_filtered_Trib
  geom_point(data = Salmon_unimpaired_tribs, aes(x = Rel_Water_Area_plotting, y = f_Fe_mcg_per_l), pch = 24, color = "black", 
             #fill = "#c0eeea",
             fill = "#a1e6ce",
             #fill = "#92e2c6",
             #fill = "#b1ead6",
             size = 3.4, stroke = 1.2) +
  # Points for impaired tribs
  geom_point(data = Salmon_impaired_tribs, aes(x = Rel_Water_Area_plotting, y = f_Fe_mcg_per_l), pch = 25, color = "black", 
             fill = "indianred2", 
             size = 3.3, stroke = 1.2) +
  #coord_cartesian(x = c(0, 22), y = c(0, 45)) +
  scale_x_continuous( 
    breaks = DA_breaks,
    labels = DA_labels) +
  scale_y_continuous(breaks = c(0,100,200,300,400,500,1000,2000,5000,10000,15000,20000), labels = c(0,100,200,300,400,500,1000,2000,5000,10000,15000,20000)) +
...
geom_point(data = MS_f_Fe_long, aes(x = Rel_Water_Area_plotting, y = Metal_conc_plot), pch = 21, color = "black", 
  ...
  geom_point(data = trib_f_Fe_long, aes(x = Rel_Water_Area_plotting, y = Metal_conc_plot), pch = 24, color = "black", 
             ...
             size = 3.4, stroke = 1.2) +
  # Points for impaired tribs
  geom_point(data = impaired_f_Fe_long, aes(x = Rel_Water_Area_plotting, y = Metal_conc_plot), pch = 25, color = "black", 
             fill = "indianred2", 
             size = 3.3, stroke = 1.2) +
...
geom_point(data = MS_p_Fe_long, aes(x = Rel_Water_Area_plotting, y = Metal_conc_plot), pch = 21, color = "black", 
           #fill = "#2DAA9E",
           fill = "#185b53",
           size = 4, stroke = 1.3) +
  # Points for SalmonR_filtered_Trib
  geom_point(data = trib_p_Fe_long, aes(x = Rel_Water_Area_plotting, y = Metal_conc_plot), pch = 24, color = "black", 
             ...
             size = 3.4, stroke = 1.2) +
  # Points for impaired tribs
  geom_point(data = impaired_p_Fe_long, aes(x = Rel_Water_Area_plotting, y = Metal_conc_plot), pch = 25, color = "black", 
             fill = "indianred4", 
             size = 3.3, stroke = 1.2) +
  coord_cartesian(x = c(0, 22), y = c(5, 6000)) +
...
```{r}
SalmonR_Fe_combo <- SalmonR_Fe_bottom / SalmonR_Fe_top + plot_layout(
  heights = c(1, 4), 
  guides = "collect") & theme(plot.margin = margin(0, 5, 0, 2), panel.background = element_rect(fill = "NA", color = "NA"), # Panel background
    plot.background = element_rect(fill = "NA", color = "NA") # Plot background
    )
...
#ggsave("C:/Users/tevinger/Downloads/SalmonR Fe.png", SalmonR_Fe_combo, width = 5, height = 2.5, dpi = 300)
