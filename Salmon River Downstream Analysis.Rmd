...
SalmonR_2023_alkalinity <- calculate_Alk_from_DIC(SalmonR_2023_river_data)
...
SalmonR_2023_alkalinity$Alk_eq_L <- as.numeric(Alk_eq_L)
SalmonR_2023_alkalinity$Alk_mEq_L <- as.numeric(Alk_mEq_L)
SalmonR_2023_alkalinity$Alk_mgCaCO3_L <- as.numeric(Alk_mgCaCO3_L)
