...
```{r}
# Modified distance downstream values and classification value for Anaktok to reflect this sample site as a tributary on the Salmon in excel then brought back into R
