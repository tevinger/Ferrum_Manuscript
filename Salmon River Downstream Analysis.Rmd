...
# Save final plot
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/pH area plus heat plot_V2.png", SalmonR_pH_area_combo, width = 4.6, height = 2.15, dpi = 300)
```
...
# Save final plot
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SO4 area plus heat plot_V2.png",SalmonR_SO4_area_combo, width = 4.6, height = 2.15, dpi = 300)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/Fe area plus heat plot_V3.png", SalmonR_Fe_area_combo, width = 5, height = 2.5, dpi = 300)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SalmonR Fe_V4.png", SalmonR_Fe_bottom, width = 3.8, height = 2, dpi = 300)
```
...
# Save final plot
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/Zn area plus heat plot_V3.png",SalmonR_Zn_area_combo, width = 4.6, height = 2.5, dpi = 300)
...
SalmonR_Ni_area <- ggplot() +
  ...
  geom_ribbon(
    data = MS_u_Ni_area,
    aes(x = Rel_Water_Area_plotting, ymin = 0.001, ymax = Metal_conc),
    fill = "grey30"
  ) +
  geom_line(
    data = MS_u_Ni_area,
  ...
  geom_point(
    data = MS_f_Ni_area,  # changed to Ni
    aes(x = Rel_Water_Area_plotting, y = Metal_conc),
    pch = 19, color = "black", size = 2
  ) +
  geom_point(
    data = MS_u_Ni_area,  # changed to Ni
    aes(x = Rel_Water_Area_plotting, y = Metal_conc),
    pch = 19, color = "black", size = 2
  ) +
  ...
  theme_minimal() +
  DA_theme +
  theme(axis.ticks.length.y.right = unit(-0.1, "cm"))
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/Ni area plus heat plot_V2.png",
       SalmonR_Ni_area_combo, width = 4.6, height = 2.5, dpi = 300)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/Cd area plus heat plot_V2.png",
       SalmonR_Cd_area_combo, width = 4.6, height = 2.5, dpi = 300)
```
