...
SalmonR_2023_alkalinity <- calculate_Alk_from_DIC(data = SalmonR_2023_river_data) %>%
  relocate(Alk_eq_L, Alk_mEq_L, Alk_mgCaCO3_L, .after = DIC_mgC_per_l_qa)
...
logK1 <-  (-356.3094) + ((-0.06091964) * Temp_K) + ((21834.37) / Temp_K) + ((126.8339) * log10(Temp_K)) + ((-1119669) / (Temp_K^2))
K1 <- 10^logK1
...
# Calculate [H+] from pH
  ...
  # Add result to data
  SalmonR_MS2$Alk_eq_L <- Alk_eq_L
  SalmonR_MS2$Alk_mEq_L <- Alk_mEq_L
  SalmonR_MS2$Alk_mgCaCO3_L <- Alk_mgCaCO3_L
