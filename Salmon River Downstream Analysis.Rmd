...
SalmonR_Fe_area <- ggplot() +
  ...
  geom_tile(data = trib_f_Fe_area,
            aes(x = Rel_Water_Area_plotting, y = 10, fill = Metal_conc),
            height = 0.5,  # controls thickness of tile band
            width = 0.1) +  # controls horizontal width
...
### Trib heat plot
```{r}
f_Fe_heat <- ggplot(trib_f_Fe_area, aes(x = Rel_Water_Area_plotting, y = 1, fill = Metal_conc)) +
