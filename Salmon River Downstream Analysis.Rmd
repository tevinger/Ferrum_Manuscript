...
# Save final plot
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/M_SO4 area plus heat plot_with labels.png",SalmonR_SO4_area_combo, width = 3.6, height = 1.8, dpi = 300)
```
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/Cd area plus heat plot_no labels.png",
       SalmonR_Cd_area_combo, width = 3.58, height = 2.1, dpi = 300)
```
