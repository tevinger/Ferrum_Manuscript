...
SalmonR_SO4_Cl_area <- ggplot() +
  ...
  coord_cartesian(x = c(1,22.5), y = c(0,225)) +
  scale_x_continuous(breaks = DA_x_breaks, labels = DA_x_labels,
                     expand = expansion(mult = c(0.035, 0.015))) +
...
SalmonR_Cu_area <- ggplot() +
  ...
  annotate(
    "segment",
    x = 0, xend = .6,  # <-- adjust for your x scale; this is the "inward" length
    y = y_breaks, yend = y_breaks,
    linewidth = .75, color = "black"
  )
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SI Figures/Cu area plus heat plot_with labels.png",SalmonR_Cu_area_combo, width = 3.5, height = 2.1, dpi = 300)
...
SalmonR_Mn_area <- ggplot() +
  ...
  geom_vline(xintercept = c(3.75, 6.35, 4.75, 6.25, 8.00, 8.10, 9.0, 10.8, 11),
             linetype = "dashed", color = "grey15", linewidth = 0.5) +
  coord_cartesian(x = c(1,22.5), y = c(1,2300)) +
  scale_x_continuous(breaks = DA_x_breaks, labels = DA_x_labels,
                     expand = expansion(mult = c(0.035, 0.015))) +
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SI Figures/Mn area plus heat plot_without labels.png", SalmonR_Mn_area_combo, width = 3.5, height = 2.1, dpi = 300)
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SI Figures/Al area plus heat plot_without labels.png", SalmonR_Al_area_combo, width = 3.5, height = 2.1, dpi = 300)
```
...
SalmonR_REE_area <- ggplot() +
  ...
  geom_vline(xintercept = c(3.75, 6.35, 4.75, 6.25, 8.00, 8.10, 9.0, 10.8, 11),
             linetype = "dashed", color = "grey15", linewidth = 0.5) +
  coord_cartesian(x = c(1,22.5), y = c(0.01,250)) +
  scale_x_continuous(breaks = DA_x_breaks, labels = DA_x_labels,
                     expand = expansion(mult = c(0.035, 0.015))) +
  # scale_y_continuous(breaks = c(0,25,50,75,100,125), labels = c(0,"",50,"",100,""), sec.axis = dup_axis(), expand = expansion(mult = c(0.02, 0.02))) +
  scale_y_continuous(
    trans = pseudo_log_trans(base = 10),
    breaks = c(0,1,10,100),
    labels = c(0,1,10,100),
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SI Figures/REE area plus heat plot_without labels.png",SalmonR_REE_area_combo, width = 3.5, height = 2.1, dpi = 300)
...
```{r}
f_Co_heat_legend <- ggpubr::get_legend(f_Co_heat)

ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/f_Co_heat_legend.png",cowplot::ggdraw(f_Co_heat_legend), width = 4, height = 2, dpi = 300)

p_Co_heat_legend <- ggpubr::get_legend(p_Co_heat)

ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/p_Co_heat_legend.png",cowplot::ggdraw(p_Co_heat_legend), width = 4, height = 2, dpi = 300)
```
...
SalmonR_Co_area <- ggplot() +
  ...
  geom_point(data = MS_f_Co_area,
             aes(x = Rel_Water_Area_plotting, y = Metal_conc),
             pch = 21, fill = "black", color = "black", size = 2) +
  geom_point(data = MS_u_Co_area,
             aes(x = Rel_Water_Area_plotting, y = Metal_conc),
             pch = 19, color = "black", size = 2) +
  geom_vline(xintercept = c(3.75, 6.35, 4.75, 6.25, 8.00, 8.10, 9.0, 10.8, 11),
             linetype = "dashed", color = "grey15", linewidth = 0.5) +
  coord_cartesian(x = c(1,22.5), y = c(0,250)) +
  scale_x_continuous(breaks = DA_x_breaks, labels = DA_x_labels,
                     expand = expansion(mult = c(0.035, 0.015))) +
  scale_y_continuous(
    trans = pseudo_log_trans(base = 10),
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SI Figures/Co area plus heat plot_without labels.png", SalmonR_Co_area_combo, width = 3.5, height = 2.1, dpi = 300)
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/SI Figures/Se area plus heat plot_without labels.png", SalmonR_Se_area_combo, width = 3.5, height = 2.1, dpi = 300)
```
...
SalmonR_Alk_area <- ggplot() +
  ...
  scale_x_continuous(breaks = DA_x_breaks, labels = DA_x_labels,
                     expand = expansion(mult = c(0.035, 0.015))) +
  scale_y_continuous(breaks = c(0,50,100,150,200), labels = c(0,50,100,150,200), sec.axis = dup_axis(), expand = expansion(mult = c(0.02, 0.02))) +
  labs(x = NULL, y = NULL, title = NULL) +
  theme_minimal() +
  theme(axis.text.y.right = element_blank(),
        axis.text.y.left = element_blank()) +
...
ggsave("C:/Users/tevinger/Box/Poulin Lab ETOX/Project Folders/Alaska BITE_HEAT (Taylor Evinger)/Evinger Manuscripts/Ferrum Manuscript/Figures/03_Downstream Analysis/Alk area plus heat plot_without labels.png", SalmonR_Alk_area_combo, width = 3.55, height = 1.8, dpi = 300)
```
